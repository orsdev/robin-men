...
import { TIME_FRAME_DATA } from './constants';
...
export function ChatFilterDrawer({
  ...
  return (
    <>
      <div
        className={cn(
          'absolute top-0 left-0 w-full h-full z-[-1] bg-transparent transition duration-200 delay-150',
          {
            'bg-black/50 z-[9] visible opacity-100': open
          }
        )}
