    ...
    <>
      <DayPicker
        ...
        classNames={{
          ...
          day_selected:
            'bg-others-400 text-white hover:bg-blue-400 hover:text-white focus:bg-others-400 focus:text-white dark:bg-neutral-50 dark:text-neutral-900 dark:hover:bg-neutral-50 dark:hover:text-neutral-900 dark:focus:bg-neutral-50 dark:focus:text-neutral-900',
          day_today:
